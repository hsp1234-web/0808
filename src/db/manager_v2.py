...
ACTION_MAP = {
    "initialize_database": database_v2.initialize_database,
    "add_task": database_v2.add_task,
    "fetch_and_lock_task": database_v2.fetch_and_lock_task,
    "update_task_progress": database_v2.update_task_progress,
    "update_task_status": database_v2.update_task_status,
    "get_task_status": database_v2.get_task_status,
    "are_tasks_active": database_v2.are_tasks_active,
    "get_all_tasks": database_v2.get_all_tasks,
    "get_system_logs": database_v2.get_system_logs_by_filter,
    "find_dependent_task": database_v2.find_dependent_task,
    # JULES'S NEW FEATURE: Add app state actions
    "get_app_state": database_v2.get_app_state,
    "set_app_state": database_v2.set_app_state,
    "get_all_app_states": database_v2.get_all_app_states,
    # For testing:
    "clear_all_tasks": database_v2.clear_all_tasks,
}
...
def run_server():
    ...
    try:
        ...
        database_v2.initialize_database()
        log.info("✅ 資料庫初始化成功。")

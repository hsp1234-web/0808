...
def test_trigger_youtube_processing_success(mock_db_client, mock_subprocess, mock_websocket_manager):
    ...
    tool_name = "mock_youtube_downloader_v2.py" if api_server.IS_MOCK_MODE else "youtube_downloader_v2.py"
...
def test_mock_youtube_downloader_script(tmp_path):
    ...
    output_dir = tmp_path
    tool_path = api_server.ROOT_DIR / "src" / "tools" / "mock_youtube_downloader_v2.py"

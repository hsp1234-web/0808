...
test.describe('MPA v2 Navigation', () => {
  ...
  test('should navigate to all v2 pages and check titles', async ({ page }) => {
    ...
    await expect(page.locator('a.tab-button.active')).toHaveText('📁 本機檔案轉錄');
    ...
    await expect(page.locator('a.tab-button.active')).toHaveText('📥 媒體下載器');
    ...
    await expect(page.locator('a.tab-button.active')).toHaveText('▶️ YouTube 轉報告');
    ...
    await expect(page.locator('a.back-link')).toHaveAttribute('href', 'index_v2.html');

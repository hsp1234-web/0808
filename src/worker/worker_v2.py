...
async def process_transcription_task(task: dict):
    ...
    try:
        ...
        tool_script = "mock_transcriber_v2.py" if is_mock_mode else "transcriber_v2.py"
...
async def process_youtube_task(task: dict):
    ...
    try:
        ...
        if task_type in ['youtube_download', 'youtube_download_only']:
            ...
            downloader_script = "mock_youtube_downloader_v2.py" if is_mock_mode else "youtube_downloader_v2.py"
        ...
        if task['type'] == 'gemini_process':
            ...
            processor_script = "mock_gemini_processor_v2.py" if is_mock_mode else "gemini_processor_v2.py"
